...
# Create CSV file
csv = open("emotions.csv", "w")
csv.write("emotion,dist_l,dist_r,dist_eyes,dist_mouth_nose,hght_mouth,wdth_mouth\n")
...
for img in glob.glob("projectImages/[A-M][0-9]*.bmp"): #THIS IS FOR TRAINING DATA
#for img in glob.glob("projectImages/A[0-9]*.bmp"): # Try on test subject 1
	...
	csv.write("{},{}\n".format(emotion, ",".join([str(s) for s in distList])))
